    ...
    <div className="flex min-h-screen w-full relative overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          ...
          priority
        />
        {/* Darker overlay — was bg-white/10, now a deep dark tint */}
      ...
      <div className="relative z-10 flex w-full flex-col lg:flex-row max-w-[1800px] mx-auto">
        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-center p-16 lg:pl-32 xl:pl-48">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-10 w-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center shadow-lg border border-white/30">
              <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
            </div>
            <span className="text-2xl font-bold tracking-tight text-white drop-shadow">SyncFlow</span>
          </div>
          
          <h1 
            className="text-5xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-tight text-white"
            style={{ 
              textShadow: "1px 1px 0px #818cf8, 2px 2px 0px #6366f1, 3px 3px 0px #4f46e5, 4px 4px 0px #4338ca, 5px 5px 0px #3730a3, 6px 6px 0px #312e81, 0 15px 30px rgba(0,0,0,0.4)" 
            }}
          >
            SYNC YOUR<br />WORKFLOW
          </h1>
          <p className="text-xl text-white/90 max-w-xl font-bold drop-shadow">
            Where Your Team's Productivity Becomes Reality.
          </p>
          <p className="text-base text-white/70 mt-4 max-w-md font-medium">
